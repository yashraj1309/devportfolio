...
const icons = [
  {
    link: "https://www.hackerrank.com/dudhatrayashraj",
    title: "Hackerrank",
    svg: (
      <svg
  ...
  {
    link: "https://github.com/yashraj1309",
    title: "Github",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
  ...
  {
    link: "https://www.linkedin.com/in/yashraj-dudhatra-299aba237/",
    title: "Linked In",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
  ...
  {
    link: "https://leetcode.com/YASHRAJ_DUDHATRA/",
    title: "LeetCode",
    svg: (
      <svg
        width="24px"
  ...
  {
    link: "https://medium.com/@dudhatrayashraj",
    title: "Medium",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export default function Footer() {
  return (
    <>
      ...
      <footer>
        <div>
          <div className="abc">BUILT FROM SCRATCH BY ME :{")"}</div>
          <div className="logofooter">
            <h1>Yashraj Dudhatra</h1>
